                    ...
                    <div class="product-view-items product-grid col-12 col-sm-12 col-lg-9 sidebar-right">
                        ...
                        <div class="products products-lists">
                            <div class="row row-sp row-eq-height">
                                            ...
                                            <div class="account-inner-primary" style="margin-bottom: 20px; margin-left:15px">
                                                <div class="account-nav">
                                                    <div class="nav-pills" id="v-pills-tab" role="tablist">
                                                        <a class="btn open-quickview-popup nav-link active btn-block" id="my-account-home-tab" href="#open-quickview-popups" title="Click to post" role="tab" aria-controls="my-account-home" aria-selected="true">Sale Bike Parts </a>
                                                    </div>
                                                </div>
                                            </div>
                                <?php  }
                                ...
                                $totalEmpSQL = "SELECT COUNT(*) AS total FROM `bike_parts_details_table` WHERE post_delete != ? AND posted_by = ?";
                                ...
                                $query = "SELECT * FROM `bike_parts_details_table` WHERE post_delete != ? AND posted_by = ? ORDER BY id DESC LIMIT ?, ?";
                                ...
                                <?php if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        $item_availability = htmlspecialchars($row['part_availability']); ?>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <div style="margin-top: 30px; border: 2px solid #ccc; padding: 20px;">
                                                                                    <p>
                                                                                        <?php
                                                                                        $post_identy = htmlspecialchars($row['id']);
                                                                                        $stmt = $conn->prepare("SELECT `id`, `image_name`, random_string FROM `parts_images` WHERE post_id = ? AND delete_image = '' ORDER BY id DESC");
                                                                                        $stmt->bind_param("s", $post_identy);
                                                                                        ...
                                                                                        <ul class="instagram-gallery row">
                                                                                            <?php foreach ($imageData as $image) { ?>
                                                                                                <li class="col-4 col-sm-3 col-md-2 col-lg-4 item" style="margin-bottom: 10px;">
                                                                                                    ...
                                                                                                    <hr />
                                                                                                    <form method="post" action="sell_bike_parts_handler.php">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="shadow-lg p-3 mb-5 bg-white rounded" style="margin-top: 30px;">
                                                                                    <form action="sell_bike_parts_handler.php" method="POST" style="padding: 20px;" enctype="multipart/form-data">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <br />
                                                                                            <br />
                                                                                            <input type="file" class="form-control-file" name="parts_images[]" multiple required />
                                                                ...
                                                                <div id="edit_post<?php echo htmlspecialchars($row['id']); ?>" class="quickview-popup magnific-popup mfp-hide">
                                                                    <div class="quickview-content">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="shadow-lg p-3 mb-5 bg-white rounded" style="margin-top: 30px;">
                                                                                    <form action="sell_bike_parts_handler.php" method="POST" style="padding: 20px;">
                                                                                        <input type="hidden" class="form-control" name="parts_id" value="<?php echo htmlspecialchars($row['id']) ?>" required />
                                                                                        <input type="hidden" class="form-control" name="string_id" value="<?php echo htmlspecialchars($row['random_string_id']) ?>" required />
                                                                                        <div class="form-group">
                                                                                            <label>Motorbike Part Name</label>
                                                                                            <input type="text" class="form-control" value="<?php echo htmlspecialchars($row['part_name']) ?>" name="part_name" required />
                                                                                        </div>
                                                                                        <br>
                                                                                        <div class="form-group">
                                                                                            <label>Price</label>
                                                                                            <input type="number" class="form-control" value="<?php echo htmlspecialchars($row['part_price']) ?>" name="part_price" required />
                                                                                        </div>
                                                                                        <br>
                                                                                        <div class="form-group">
                                                                                            <label>Condition</label>
                                                                                            <select class="form-control" name="part_condition" required>
                                                                                                <option value="" disabled selected> </option>
                                                                                                <option value="Brand New" <?php if ($row['part_condition'] == 'Brand New')
                                                                                                                                echo 'selected'; ?>>Brand New</option>
                                                                                                <option value="Like New" <?php if ($row['part_condition'] == 'Like New')
                                                                                                                                echo 'selected'; ?>>Like New</option>
                                                                                                <option value="Used - Excellent" <?php if ($row['part_condition'] == '"Used - Excellent')
                                                                                                                                        echo 'selected'; ?>>Used - Excellent</option>
                                                                                                <option value="Used - Good" <?php if ($row['part_condition'] == 'Used - Good')
                                                                                                                                echo 'selected'; ?>>Used - Good</option>
                                                                                                <option value="Used - Fair" <?php if ($row['part_condition'] == '"Used - Fair')
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <input type="text" class="form-control" value="<?php echo htmlspecialchars($row['part_location']) ?>" name="part_location" required />
                                                                                        </div>
                                                                                        <br>
                                                                                        <div class="cart-note">
                                                                                            <div class="form-group">
                                                                                                <label for="cart-note">Other details</label>
                                                                                                <textarea class="form-control" value="<?php echo htmlspecialchars($row['part_details']) ?>" name="part_details" id="cart-note" rows="15" required><?php echo htmlspecialchars($row['part_details']) ?></textarea>
                                                                                            </div>
                                                                                        </div>
                                                                                        <br>
                                                                                        <div class="cart-checkout">
                                                                    ...
                                                                    <div class="quickview-content">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6" style="text-align:center">
                                                                                <div class="shadow-lg p-3 mb-5 bg-white rounded" style="margin-top: 30px;">
                                                                                    <form action="sell_bike_parts_handler.php" method="POST" style="padding: 20px;">
                                                                                        <input type="hidden" class="form-control" name="part_id" value="<?php echo htmlspecialchars($row['id']) ?>" required />
                                                                                        <input type="hidden" class="form-control" name="string_id" value="<?php echo htmlspecialchars($row['random_string_id']) ?>" required />
                                                                    ...
                                                                    <div class="shadow-lg p-3 mb-5 bg-white rounded" style="margin-top: 30px;">
                                                                        <form action="sell_bike_parts_handler.php" method="POST" style="padding: 20px;">
                                                                            ...
                                                                            <div class="cart-checkout" style="text-align:center">
                                                                                <button type="submit" name="sold_part" class="btn btn-danger btn-block">Item
                                                                                    sold</button>
                                                                        </form>
                                                                    </div>
                                                                    </form>
                                        ...
                                        <div class="product-details col-md-4">
                                            <div class="col-md-6">
                                                <h3 class="product-title">
                                                    <strong>
                                                        <?php echo htmlspecialchars($row['part_name'], ENT_QUOTES, 'UTF-8'); ?>
                                                    </strong>
                                                </h3>
                                                <div class="product-description">
                                                    <p>
                                                        <strong>Condition: </strong>
                                                        <?php echo htmlspecialchars($row['part_condition'], ENT_QUOTES, 'UTF-8'); ?>
                                                        <br>
                                                        <strong>Location: </strong>
                                                        <?php echo htmlspecialchars($row['part_location'], ENT_QUOTES, 'UTF-8'); ?>
                                                        <br>
                                                        <br>
                                                        <strong>Price: </strong>
                                                        <b style="color:#F76D2b">
                                                            <?php echo number_format((float) $row['part_price'], 2); ?>
                                                        </b>
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="product-details col-md-4">
                                            ...
                                            <br>
                                            <?php echo nl2br(htmlspecialchars($row['part_details'], ENT_QUOTES, 'UTF-8')); ?>
                                        </div>
                            </div>
                        </div>
                    <?php }
...
<div id="open-quickview-popups" class="quickview-popup magnific-popup mfp-hide">
    <div class="quickview-content">
        <h5 class="text-center">Read carefully these instructions before submitting your post</h5>
        <hr>
        <div class="row">
            <div class="col-md-6">
                <div style="margin-top: 30px; border: 2px solid #ccc; padding: 20px;">
            ...
            <div class="col-md-6">
                <div class="shadow-lg p-3 mb-5 bg-white rounded" style="margin-top: 30px;">
                    <form action="sell_bike_parts_handler.php" method="POST" style="padding: 20px;">
                        ...
                        <div class="form-group">
                            <label>Price</label>
                            <input type="number" class="form-control" name="part_price" required />
                        </div>
                        <br>
                        <div class="form-group">
                            <label>Condition</label>
                        ...
                        <div class="form-group">
                            <label>Location</label>
                            <input type="text" class="form-control" name="part_location" required />
                        </div>
                        <br>
                        <div class="cart-note">
                            <div class="form-group">
                                <label for="cart-note">Other details</label>
                                <textarea class="form-control" name="part_details" id="cart-note" rows="15" required></textarea>
                            </div>
                        </div>
                        <br>
