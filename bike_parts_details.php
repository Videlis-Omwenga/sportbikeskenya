...
<main class="main-content">
    ...
    if (isset($_GET['post_id']) && isset($_GET['position'])) {
        ...
        try {
            $selectStmt = $conn->prepare("SELECT * FROM bike_parts_details_table WHERE id = ? AND random_string_id = ?");
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    $part_availability_details = $row["part_availability"];

                    //Get seller information
                    $businesss_name = $businesss_email = $businesss_contacts = ''; // Declare the global variable
                    $part_posted = htmlspecialchars($row['posted_by'], ENT_QUOTES, 'UTF-8');
                    ...
                    try {
                        ...
                        header('Location: bike_parts_details.php.php');
                        exit;
                    }
                            ...
                            <div class="row">
                                        ...
                                        <div class="product-single-img-slider position-relative">
                                            <div class="product-group-photo">
                                                ...
                                                <div class="row no-gutters">
                                                    <?php
                                                    $part_identity = htmlspecialchars($row['id']);
                                                    $stmt = $conn->prepare("SELECT `image_name` FROM `parts_images` WHERE post_id = ? AND delete_image = '' ORDER BY id DESC LIMIT 6");
                                                    $stmt->bind_param("s", $part_identity);

                                                    if ($stmt->execute()) {
                                                        $part_img_results = $stmt->get_result();

                                                        if ($part_img_results->num_rows > 0) {
                                                            $imageNames = array();

                                                            while ($part_img_rows = $part_img_results->fetch_assoc()) {
                                                                $imageNames[] = $part_img_rows['image_name'];
                                                            }
                                ...
                                <div class="col-12 col-sm-12 col-md-6 product-info-details">
                                    ...
                                    <div class="product-label">
                                        <?php if ('' == $part_availability_details) { ?>
                                    ...
                                    <div class="group-product-tbl table-responsive">
                                        <table class="table table-bordered mb-4">
                                            <thead>
                                                <tr>
                                                    <th>Part name</th>
                                                    <th><?php echo htmlspecialchars($row['part_name'], ENT_QUOTES, 'UTF-8'); ?></th>
                                                </tr>
                                                <tr>
                                                    <th>Parts condition</th>
                                                    <th><?php echo htmlspecialchars($row['part_condition'], ENT_QUOTES, 'UTF-8'); ?></th>
                                                </tr>
                                                <tr>
                                                    <th>Parts location</th>
                                                    <th><?php echo htmlspecialchars($row['part_location'], ENT_QUOTES, 'UTF-8'); ?></th>
                                                </tr>
                                                <tr>
                                                    <th>Parts details</th>
                                                    <th> <?php echo nl2br(htmlspecialchars($row['part_details'], ENT_QUOTES, 'UTF-8')); ?>
                                                    </th>
                                                </tr>
                                                <tr style="color:green">
                                                    <th>Part price</th>
                                                    <th><?php echo number_format((float) $row['part_price'], 2); ?>
                                                    </th>
                                                </tr>
                                                                                ...
                                                                                <div class="row row-sp">
                                                                                    <div class="col-sp col-12 col-sm-12 col-md-12 col-lg-6 offset-lg-3">
                                                                                        ...
                                                                                        <form action="form_handler.php" method="POST">
                                                                                            <input type="hidden" class="form-control" name="track_item" value="Bike_parts_tracking" />
    ...
    <?php }
            ...
            $_SESSION['error'] = "Error retrieving bike parts details!";
        }
    }
    ?>
    ...
    <main class="main-content" style="margin-bottom: 280px; margin-top: 100px">
        ...
        <div class="tabs-header clearfix">
            <div class="section-header">
                ...
                <p>Because you clicked on bike parts on sale</p>
            </div>
        </div>
        <!-- Start Cart Details -->
                        ...
                        <div class="product-view-items product-grid col-12 col-sm-12 col-lg-9 sidebar-right">
                            ...
                            <div class="products products-grid">
                                <div class="row row-sp row-eq-height">
                                    ...
                                    $query = "SELECT * FROM `bike_parts_details_table` WHERE post_delete != ? ORDER BY id DESC LIMIT 24";
                                    ...
                                    if ($stmt->execute()) {
                                        ...
                                        $_SESSION['error'] = "Error fetching bike parts details!";
                                        header('Location: bike_parts_details.php');
                                        exit;
                                    }
