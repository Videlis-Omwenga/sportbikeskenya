...
<main class="main-content">
    ...
    if (isset($_GET['post_id']) && isset($_GET['position'])) {
        ...
        try {
            $selectStmt = $conn->prepare("SELECT * FROM gears_details_table WHERE id = ? AND random_string_id = ?");
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    $gear_availability_details = $row["item_availability"];
                    ...
                    try {
                        ...
                        header('Location: gear_details.php');
                        exit;
                    }
                            ...
                            <div class="row">
                                        ...
                                        <div class="product-single-img-slider position-relative">
                                            <div class="product-group-photo">
                                                ...
                                                <div class="row no-gutters">
                                                    <?php
                                                    $gear_identity = htmlspecialchars($row['id']);
                                                    $stmt = $conn->prepare("SELECT `image_name` FROM `gears_images` WHERE post_id = ? AND delete_image = '' ORDER BY id DESC LIMIT 6");
                                                    $stmt->bind_param("s", $gear_identity);

                                                    if ($stmt->execute()) {
                                                        $gear_img_results = $stmt->get_result();

                                                        if ($gear_img_results->num_rows > 0) {
                                                            $imageNames = array();

                                                            while ($gear_img_rows = $gear_img_results->fetch_assoc()) {
                                                                $imageNames[] = $gear_img_rows['image_name'];
                                                            }
                                                    ...
                                                    ?>
                                                            ...
                                                            <?php foreach ($imageNames as $imageName) { ?>
                                                                <div class="single-item col-6 product-gallery-image">
                                                                    <div class="zoom item">
                                                                        <img class="img-fluid blur-up lazyload" src="seller_images/<?php echo htmlspecialchars($imageName); ?>" alt="image" title="<?php echo htmlspecialchars($imageName); ?>" title="Gear Image" />
                                                                    </div>
                                                                </div>
                                                            <?php } ?>
                                                        <?php } else { ?>
                                ...
                                <div class="col-12 col-sm-12 col-md-6 product-info-details">
                                    ...
                                    <div class="product-label">
                                        <?php if ('' == $gear_availability_details) { ?>
                                    ...
                                    <div class="group-product-tbl table-responsive">
                                        <table class="table table-bordered mb-4">
                                            <thead>
                                                <tr>
                                                    <th>Gear name</th>
                                                    <th><?php echo htmlspecialchars($row['gear_name'], ENT_QUOTES, 'UTF-8'); ?></th>
                                                </tr>
                                                <tr>
                                                    <th>Gear condition</th>
                                                    <th><?php echo htmlspecialchars($row['gear_condition'], ENT_QUOTES, 'UTF-8'); ?></th>
                                                </tr>
                                                <th>Gear location</th>
                                                <th>
                                                ...
                                                <tr>
                                                    <th>Gear details</th>
                                                    <th> <?php echo nl2br(htmlspecialchars($row['gear_details'], ENT_QUOTES, 'UTF-8')); ?>
                                                    </th>
                                                </tr>
                                                </tr>
                                                <tr style="color:green">
                                                    <th>Gear price</th>
                                                    <th><?php echo number_format((float) $row['gear_price'], 2); ?>
                                                    </th>
                                                </tr>
                                                                                ...
                                                                                <div class="row row-sp">
                                                                                    <div class="col-sp col-12 col-sm-12 col-md-12 col-lg-6 offset-lg-3">
                                                                                        ...
                                                                                        <form action="form_handler.php" method="POST">
                                                                                            <input type="hidden" class="form-control" name="track_item" value="Gear_tracking" />
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <textarea minlength="20" type="password" name="issue_details" class="form-control" rows="15" required></textarea>
                                                                                            ...
                                                                                            <div class="cart-checkout">
                                                                                                <button type="submit" name="report_post_gear" class="btn btn-primary btn-block">Submit report</button>
                                                                                            </div>
                                                                                        </form>
                                                                                    </div>
                                                                                </div>
    ...
    <?php }
            ...
            $_SESSION['error'] = "Error retrieving gear details!";
        }
    }
    ?>
    ...
    <main class="main-content" style="margin-bottom: 280px; margin-top: 100px">
        ...
        <div class="tabs-header clearfix">
            <div class="section-header">
                ...
                <p>Because you clicked on gears on sale</p>
            </div>
        </div>
        <!-- Start Cart Details -->
                        ...
                        <div class="product-view-items product-grid col-12 col-sm-12 col-lg-9 sidebar-right">
                            ...
                            <div class="products products-grid">
                                <div class="row row-sp row-eq-height">
                                    ...
                                    $query = "SELECT * FROM `gears_details_table` WHERE post_delete != ? ORDER BY id DESC LIMIT 24";
                                    ...
                                    if ($stmt->execute()) {
                                        ...
                                        $_SESSION['error'] = "Error fetching gear details!";
                                    ...
                                    <?php if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            $gear_availability = htmlspecialchars($row['item_availability'], ENT_QUOTES, 'UTF-8');
                                    ?>
                                                        ...
                                                        <div class="product-image">
                                                                ...
                                                                if ($stmt->execute()) {
                                                                    ...
                                                                    if ($results->num_rows > 0) {
                                                                        ...
                                                                        <div class="product-label">
                                                                            <?php if ('' == $gear_availability) { ?>

                                                                            <?php } else { ?>
                                                                                <span class="label sale">Sold</span>
                                                                            <?php } ?>
                                                                        </div>
                                                                        <a href="gear_details.php?post_id=<?php echo htmlspecialchars($row['random_string_id'], ENT_QUOTES, 'UTF-8') ?>&position=<?php echo htmlspecialchars($row['id'], ENT_QUOTES, 'UTF-8') ?>&img=<?php echo htmlspecialchars($imageName); ?>&name=<?php echo htmlspecialchars($row['gear_name'], ENT_QUOTES, 'UTF-8') ?>&price=<?php echo htmlspecialchars($row['gear_price'], ENT_QUOTES, 'UTF-8') ?>">
                                                                            <img class="img-fluid blur-up lazyload" src="seller_images/<?php echo htmlspecialchars($imageName); ?>" style="max-height: 200px; min-height: 200px;" />
                                                                        </a>
                                                                        <?php } else { ?>
                                                                            <img class="img-fluid blur-up lazyload" src="assets/images/usable/not_found.png" alt="" style="max-height: 200px; min-height: 200px;" title="You cannot open. No image">
