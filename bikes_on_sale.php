                    ...
                    <div class="product-view-items product-grid col-12 col-sm-12 col-lg-9 sidebar-right">
                        ...
                        <div class="products products-grid">
                            <div class="row row-sp row-eq-height">
                                ...
                                $totalEmpSQL = "SELECT COUNT(*) AS total FROM `bike_details_table` WHERE post_delete != ?";
                                ...
                                $query = "SELECT * FROM `bike_details_table` WHERE post_delete != ? ORDER BY id DESC LIMIT ?, ?";
                                ...
                                if ($stmt->execute()) {
                                    ...
                                    header('Location: bikes_on_sale.php');
                                    exit;
                                }
