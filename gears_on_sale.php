                    ...
                    <div class="product-view-items product-grid col-12 col-sm-12 col-lg-9 sidebar-right">
                        ...
                        <div class="products products-grid">
                            <div class="row row-sp row-eq-height">
                                ...
                                $totalEmpSQL = "SELECT COUNT(*) AS total FROM `gears_details_table` WHERE post_delete != ?";
                                ...
                                $query = "SELECT * FROM `gears_details_table` WHERE post_delete != ? ORDER BY id DESC LIMIT ?, ?";
                                        ...
                                        <div class="col-sp col-md-3 col-sm-6 col-6">
                                            <div class="product-item">
                                                ...
                                                <div class="product-details">
                                                    <h3 class="product-title"><?php echo htmlspecialchars($row['gear_name'], ENT_QUOTES, 'UTF-8'); ?></h3>
                                                    <div class="product-price">
                                                        <span class="sale-price"><?php echo number_format((float) $row['gear_price'], 2); ?></span>
                                                    </div>
                                                    <br>
